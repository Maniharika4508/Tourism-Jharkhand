...
`;async function m(e){try{let t,i,a;let{searchParams:s}=new URL(e.url),n=s.get("format")||"csv",o=s.get("timeRange")||"7d",l=v(o);switch(n.toLowerCase()){case"csv":t=c(l),i="text/csv",a=`tourism-analytics-${o}.csv`;break;case"xlsx":t=p(l),i="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",a=`tourism-analytics-${o}.xlsx`;break;case"pdf":t=u(l),i="application/pdf",a=`tourism-analytics-${o}.pdf`;break;case"json":t=d(l),i="application/json",a=`tourism-analytics-${o}.json`;break;default:return r.NextResponse.json({error:"Unsupported format"},{status:400})}let m=new r.NextResponse(t);return m.headers.set("Content-Type",i),m.headers.set("Content-Disposition",`attachment; filename="${a}"`),m}catch(e){return console.error("Export error:",e),r.NextResponse.json({error:"Failed to generate export"},{status:500})}}let g=new s.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/analytics/export/route",pathname:"/api/analytics/export",filename:"route",bundlePath:"app/api/analytics/export/route"},resolvedPagePath:"C:\\Users\\Maniharika\\OneDrive\\画像\\Desktop\\SIH-Tourism\\Tourism-Jharkhand\\app\\api\\analytics\\export\\route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:A,staticGenerationAsyncStorage:y,serverHooks:h}=g,w="/api/analytics/export/route";function k(){return(0,o.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:y})}}};var t=require("../../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),a=t.X(0,[276,972],()=>i(67578));module.exports=a})();